...
package body fechas is
   ...
   -- Que hace: Suma (o resta) dias a una fecha y devuelve la nueva fecha
   -- Precondicion: fecha = F, dias = D
   -- Poscondicion: sumaDias = F' y F' es F agregando los dias informados en D
   function sumaDias(fecha: in tFecha; dias: in Integer) return tFecha is
      f: tFecha;
      tope, d: integer;
   begin
      f.dia := fecha.dia;
